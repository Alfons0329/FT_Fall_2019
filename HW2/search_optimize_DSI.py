# This file is for param search (optimizing) only for DSI stock
'''
Work progress:
'''
...
if __name__=='__main__':
    ...
    fileList = ['DSI.csv']# Init file names
    ...
    alist = np.arange(0.539, 1.0, 0.001)
    blist = np.arange(0.0, 1.0, 0.001)
    abest = 0; bbest = 0;
